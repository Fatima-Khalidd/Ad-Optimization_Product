...
5b. **The original definition.** A recommended cut is not recovered money. Proposed definition: waste on previously flagged segments in the baseline period, minus waste on those same segments in the current period. The system calculates a **suggested** amount and the admin confirms or edits it before it reaches an invoice.
